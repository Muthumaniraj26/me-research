...
def run_vshape_62cm_tssc():
    ...
    # ------------------ SHAPE: V-SHAPE
    irr_factor = 1.05          # diffuse + reflected irradiance gain
    shape_temp_offset = -1     # moderate radiative cooling

    # ------------------ SPACING: 62 cm (LOW CLEARANCE)
    spacing_offset = 4         # thermal penalty due to reduced airflow

    # ------------------ CONNECTION: TWO-STEP STAIRCASE (TSSC)
    tssc_gain = 1.08           # strong mismatch mitigation
    ...
    out_file = out_dir / "VShape_62cm_TSSC_Summer_15min.csv"

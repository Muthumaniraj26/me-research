...
def run_vshape_tct_spring():
    ...
    # -------- Shape: V-SHAPE
    irr_factor = 1.05          # diffuse + reflected gain
    ...
    for spacing_cm, spacing_offset in spacing_cases.items():
        ...
        out_file = out_dir / f"VShape_{spacing_cm}cm_TCT_Spring_15min.csv"

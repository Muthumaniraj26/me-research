...
def run_vshape_tssc_spring():
    ...
    shape_temp_offset = -1.0   # moderate radiative cooling
    ...
    # -------- Output directory
    out_dir = Path(r"C:\Users\muthumaniraj\Documents\me research\me research\tssc\v-shape")
    ...
    for spacing_cm, spacing_offset in spacing_cases.items():
        ...
        out_file = out_dir / f"VShape_{spacing_cm}cm_TSSC_Spring_15min.csv"
        ...
        with open(out_file, "w", newline="") as f:
            ...
            for i in range(len(timestamps)-1):
                ...
                for m in [0, 15, 30, 45]:
                    ...
                    # ---- Electrical calculations (TSSC)
                    Isc_array = (
                        Isc_stc * (G_eff / 1000)
                        * (1 + alpha_isc * dT)
                        * current_loss
                    ) * n_parallel * tssc_gain
                    ...
                    w.writerow([
                        ...
                        "V-Shape", spacing_cm, "TSSC", "Spring",
                        round(G_eff,1),
                        round(T,1),
                        round(T_cell,1),
                        round(Voc_array,2),

...
print("✅ V-Shape | 77 cm | Se-P | Spring simulation started")
...
def run_vshape_77cm_spring():
    ...
    spacing_offset = 0.0       # reference condition
    ...
    out_file = out_dir / "VShape_77cm_SeP_Spring_15min.csv"

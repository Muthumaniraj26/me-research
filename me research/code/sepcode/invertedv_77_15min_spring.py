...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_invertedv_77cm_spring():

    # -------- Location (Chittoor region)
    lat, lon = 9.6735, 77.9647

    # -------- Spring period (Feb–Mar–Apr)
    start_date = "20250201"
    end_date   = "20250430"
    ...
    # -------- Spacing: 77 cm (baseline clearance)
    spacing_offset = 0.0       # reference airflow
    ...
    # -------- Output
    out_dir = Path(r"C:\Users\muthumaniraj\Documents\me research\me research\sep\inverted-v")
    out_dir.mkdir(exist_ok=True)
    out_file = out_dir / "InvertedV_77cm_SeP_Spring_15min.csv"

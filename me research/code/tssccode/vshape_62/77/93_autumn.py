...
print("✅ V-Shape | TSSC | Autumn simulation started")
...
def run_vshape_tssc_autumn():
    ...
    for spacing_cm, spacing_offset in spacing_cases.items():
        ...
        out_file = out_dir / f"VShape_{spacing_cm}cm_TSSC_Autumn_15min.csv"
            ...
            for i in range(len(timestamps)-1):
                ...
                for m in [0, 15, 30, 45]:
                    ...
                    w.writerow([
                        ...
                        "V-Shape", spacing_cm, "TSSC", "Autumn",
                        round(G_eff,1),
                        round(T,1),
                        round(T_cell,1),
                        round(Voc_array,2),

...
print("✅ V-Shape | TCT | Autumn simulation started")
...
def run_vshape_tct_autumn():
    ...
    for spacing_cm, spacing_offset in spacing_cases.items():
        ...
        out_file = out_dir / f"VShape_{spacing_cm}cm_TCT_Autumn_15min.csv"

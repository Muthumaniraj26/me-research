...
print("✅ Inverted-V | 62 cm | Se-P Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_inverted_v_62cm_sep_winter():
    ...
    spacing_offset = 4.0       # hotter mounting
    ...
    out_file = out_dir / "InvertedV_62cm_SeP_Winter_15min.csv"
...
if __name__ == "__main__":
    run_inverted_v_62cm_sep_winter()

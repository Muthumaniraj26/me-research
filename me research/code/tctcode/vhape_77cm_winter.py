...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_vshape_77cm_tct_winter():
    ...
    # ------------------ SHAPE: V-SHAPE
    irr_factor = 1.05          # diffuse + internal reflection gain
    shape_temp_offset = -0.5   # mild radiative cooling

    # ------------------ SPACING: 77 cm (BASELINE)
    spacing_offset = 0.0       # reference spacing
    ...
    out_file = out_dir / "VShape_77cm_TCT_Winter_15min.csv"

# ============================================================
# INVERTED-V | 77 cm | TWO-STEP STAIRCASE (TSSC)
# Summer (April–June) | 15-minute resolution
# Array-level PV modeling (no wire-level simulation)
# ============================================================

print("✅ Inverted-V | 77 cm | TSSC simulation started")
...
def run_inverted_v_77cm_tssc():
    ...
    spacing_offset = 0         # medium clearance
    ...
    out_file = out_dir / "InvertedV_77cm_TSSC_Summer_15min.csv"

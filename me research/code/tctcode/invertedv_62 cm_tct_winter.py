...
print("✅ Inverted-V | 62 cm | TCT Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_invertedv_62cm_tct_winter():
    ...
    spacing_offset = 4.0       # higher thermal rise
    ...
    out_file = out_dir / "InvertedV_62cm_TCT_Winter_15min.csv"

...
print("✅ V-Shape | 62 cm | Se-P | Autumn simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_vshape_62cm_sep_autumn():
    ...
    # -------- Spacing: 62 cm (low clearance → hotter)
    spacing_offset = 4.0
    ...
    out_file = out_dir / "VShape_62cm_SeP_Autumn_15min.csv"

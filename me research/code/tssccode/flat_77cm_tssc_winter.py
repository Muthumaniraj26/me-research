...
def run_flat_77cm_tssc_winter():
    ...
    # ------------------ SPACING: 77 cm (BASELINE)
    spacing_offset = 0.0       # neutral thermal effect
    ...
    out_file = out_dir / "Flat_77cm_TSSC_Winter_15min.csv"

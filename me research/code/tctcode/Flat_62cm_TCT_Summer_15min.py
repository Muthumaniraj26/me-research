...
def run_flat_62cm_tct():
    ...
    # ------------------ SHAPE: FLAT (REFERENCE)
    irr_factor = 1.00          # no optical gain
    shape_temp_offset = 0      # no extra cooling
    ...
    out_file = out_dir / "Flat_62cm_TCT_Summer_15min.csv"

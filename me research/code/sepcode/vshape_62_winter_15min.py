# ============================================================
# V-SHAPE | 62 cm | SERIES-PARALLEL (Se-P)
# Winter (November–December–January) | 15-minute resolution
# Array-level PV modeling (no wire-level simulation)
# ============================================================

print("✅ V-Shape | 62 cm | Se-P | Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_vshape_62cm_winter():

    # -------- Location (Chittoor region)
    lat, lon = 9.6735, 77.9647

    # -------- Winter period (Nov–Dec–Jan)
    start_date = "20241101"
    end_date   = "20250131"
    ...
    # -------- Shape: V-SHAPE
    irr_factor = 1.05          # diffuse + reflected radiation
    shape_temp_offset = -1.0   # partial geometric cooling
    ...
    out_file = out_dir / "VShape_62cm_SeP_Winter_15min.csv"

# ============================================================
# INVERTED-V | 93 cm | TWO-STEP STAIRCASE (TSSC)
# Summer (April–June) | 15-minute resolution
# Array-level PV modeling (no wire-level simulation)
# ============================================================

print("✅ Inverted-V | 93 cm | TSSC simulation started")
...
def run_inverted_v_93cm_tssc():
    ...
    # ------------------ SHAPE: INVERTED-V
    irr_factor = 1.08          # East–West capture + sky view
    shape_temp_offset = -2     # strong chimney cooling

    # ------------------ SPACING: 93 cm (BEST COOLING)
    spacing_offset = -3        # maximum rooftop airflow

    # ------------------ CONNECTION: TWO-STEP STAIRCASE (TSSC)
    tssc_gain = 1.10           # highest mismatch mitigation
    ...
    # ------------------ OUTPUT FILE
    out_dir = Path("results_tssc")
    out_dir.mkdir(exist_ok=True)
    out_file = out_dir / "InvertedV_93cm_TSSC_Summer_15min.csv"

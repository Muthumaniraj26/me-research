...
# 15-minute resolution | Real NASA POWER data
# ============================================================

print("✅ Flat | 62 cm | Se-P simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_flat_62cm_sep():

    # ------------------ LOCATION
    lat, lon = 9.6735, 77.9647

    # ------------------ PERIOD (EDIT IF NEEDED)
    start_date = "20241101"
    end_date   = "20250131"
    ...
    out_file = out_dir / "Flat_62cm_SeP_15min.csv"

...
def run_inverted_v_62cm_tct():
    ...
    spacing_offset = 4         # higher operating temperature
    ...
    out_file = out_dir / "InvertedV_62cm_TCT_Summer_15min.csv"

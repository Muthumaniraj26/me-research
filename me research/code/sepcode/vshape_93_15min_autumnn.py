...
print("✅ V-Shape | 93 cm | Se-P | Autumn simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_vshape_93cm_sep_autumn():
    ...
    # -------- Spacing: 93 cm (best airflow → cooling benefit)
    spacing_offset = -3.0
    ...
    out_file = out_dir / "VShape_93cm_SeP_Autumn_15min.csv"

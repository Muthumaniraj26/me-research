...
def run_vshape_93cm_tssc():
    ...
    # ------------------ SPACING: 93 cm (BEST AIRFLOW)
    spacing_offset = -3        # strong convective cooling
    ...
    out_file = out_dir / "VShape_93cm_TSSC_Summer_15min.csv"

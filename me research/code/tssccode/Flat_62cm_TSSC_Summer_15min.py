...
print("✅ Flat | 62 cm | TSSC simulation started")
...
def run_flat_62cm_tssc():
    ...
    shape_temp_offset = 0      # no geometric cooling

    # ------------------ SPACING: 62 cm (LOW CLEARANCE)
    spacing_offset = 4         # thermal penalty due to restricted airflow
    ...
    out_file = out_dir / "Flat_62cm_TSSC_Summer_15min.csv"

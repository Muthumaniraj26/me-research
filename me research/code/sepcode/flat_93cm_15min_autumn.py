...
print("✅ Flat | 93 cm | Se-P | Autumn simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_flat_93cm_sep_autumn():

    # ------------------ LOCATION (Chittoor region)
    lat, lon = 9.6735, 77.9647

    # ------------------ AUTUMN PERIOD
    start_date = "20250901"   # September
    end_date   = "20251130"   # November
    ...
    # ------------------ SPACING: 93 cm (BEST ROOFTOP AIRFLOW)
    spacing_offset = -3.0     # cooling advantage
    ...
    out_file = out_dir / "Flat_93cm_SeP_Autumn_15min.csv"

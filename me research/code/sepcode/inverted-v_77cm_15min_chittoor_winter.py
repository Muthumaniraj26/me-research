...
print("✅ Inverted-V | 77 cm | Se-P Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_inverted_v_77cm_sep_winter():
    ...
    spacing_offset = 0.0       # reference clearance
    ...
    out_file = out_dir / "InvertedV_77cm_SeP_Winter_15min.csv"
...
if __name__ == "__main__":
    run_inverted_v_77cm_sep_winter()

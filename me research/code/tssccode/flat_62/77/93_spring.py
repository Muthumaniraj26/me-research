...
print("✅ Flat | TSSC | Spring simulation started")
...
def run_flat_tssc_spring():
    ...
    for spacing_cm, spacing_offset in spacing_cases.items():
        ...
        out_file = out_dir / f"Flat_{spacing_cm}cm_TSSC_Spring_15min.csv"

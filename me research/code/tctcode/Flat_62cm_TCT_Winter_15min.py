...
def run_flat_62cm_tct_winter():
    ...
    # ------------------ SHAPE: FLAT
    irr_factor = 1.00          # reference flat geometry
    shape_temp_offset = 0.0    # no chimney cooling

    # ------------------ SPACING: 62 cm (LOW CLEARANCE)
    spacing_offset = 4.0       # higher operating temperature

    # ------------------ CONNECTION: TCT
    tct_gain = 1.07            # mismatch mitigation gain
    ...
    out_file = out_dir / "Flat_62cm_TCT_Winter_15min.csv"

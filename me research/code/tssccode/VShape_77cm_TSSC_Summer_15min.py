...
def run_vshape_77cm_tssc():
    ...
    # ------------------ SHAPE: V-SHAPE
    irr_factor = 1.05          # diffuse + ground-reflected gain
    ...
    out_file = out_dir / "VShape_77cm_TSSC_Summer_15min.csv"

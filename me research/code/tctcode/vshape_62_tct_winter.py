...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_vshape_62cm_tct_winter():
    ...
    # ------------------ SHAPE: V-SHAPE
    irr_factor = 1.05          # diffuse + internal reflection
    shape_temp_offset = -0.5   # mild radiative cooling
    ...
    # ------------------ OUTPUT FILE
    out_dir = Path(r"C:\Users\muthumaniraj\Documents\me research\me research\tct\v shape\v-shape")
    out_dir.mkdir(exist_ok=True)
    out_file = out_dir / "VShape_62cm_TCT_Winter_15min.csv"

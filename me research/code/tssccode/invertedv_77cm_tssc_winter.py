...
print("✅ Inverted-V | 77 cm | TSSC Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_inverted_v_77cm_tssc_winter():
    ...
    out_file = out_dir / "InvertedV_77cm_TSSC_Winter_15min.csv"
...
if __name__ == "__main__":
    run_inverted_v_77cm_tssc_winter()

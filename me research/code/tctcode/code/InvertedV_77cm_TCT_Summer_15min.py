...
def run_inverted_v_77cm_tct():
    ...
    # ------------------ SHAPE: INVERTED-V
    irr_factor = 1.08          # enhanced east–west capture
    shape_temp_offset = -2     # strong chimney cooling

    # ------------------ SPACING: 77 cm
    spacing_offset = 0         # baseline clearance
    ...
    out_file = out_dir / "InvertedV_77cm_TCT_Summer_15min.csv"

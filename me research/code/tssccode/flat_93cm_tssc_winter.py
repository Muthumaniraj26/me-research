...
def run_flat_93cm_tssc_winter():
    ...
    # ------------------ SHAPE: FLAT
    irr_factor = 1.00          # reference irradiance
    shape_temp_offset = 0.0    # no geometric cooling

    # ------------------ SPACING: 93 cm (BEST COOLING)
    spacing_offset = -3.0      # reduced operating temperature

    # ------------------ CONNECTION: TSSC
    tssc_gain = 1.05           # conservative mismatch mitigation
    ...
    # ------------------ OUTPUT FILE
    out_dir = Path(r"C:\Users\muthumaniraj\Documents\me research\me research\tssc\flat")
    out_dir.mkdir(exist_ok=True)
    out_file = out_dir / "Flat_93cm_TSSC_Winter_15min.csv"

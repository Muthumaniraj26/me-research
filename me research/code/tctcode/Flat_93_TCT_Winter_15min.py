...
def run_flat_93cm_tct_winter():
    ...
    # ------------------ SHAPE: FLAT
    irr_factor = 1.00          # flat reference geometry
    shape_temp_offset = 0.0    # no chimney cooling

    # ------------------ SPACING: 93 cm (BEST COOLING)
    spacing_offset = -3.0      # reduced operating temperature

    # ------------------ CONNECTION: TCT
    tct_gain = 1.07            # mismatch mitigation factor
    ...
    # ------------------ OUTPUT FILE
    out_dir = Path(r"C:\Users\muthumaniraj\Documents\me research\me research\tct\flat")
    out_dir.mkdir(exist_ok=True)
    out_file = out_dir / "Flat_93cm_TCT_Winter_15min.csv"

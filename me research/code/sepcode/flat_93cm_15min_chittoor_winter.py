...
def run_flat_93cm_sep_winter():
    ...
    # ------------------ SHAPE: FLAT
    irr_factor = 1.00          # flat reference
    ...
    out_file = out_dir / "Flat_93cm_SeP_Winter_15min.csv"

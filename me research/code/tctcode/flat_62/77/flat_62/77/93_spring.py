...
def run_flat_tct_spring():
    ...
    for spacing_cm, spacing_offset in spacing_cases.items():
        ...
        out_file = out_dir / f"Flat_{spacing_cm}cm_TCT_Spring_15min.csv"

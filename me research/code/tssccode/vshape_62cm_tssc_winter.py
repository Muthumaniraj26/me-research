...
print("✅ V-Shape | 62 cm | TSSC Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_vshape_62cm_tssc_winter():
    ...
    # ------------------ SHAPE: V-SHAPE
    irr_factor = 1.05          # diffuse + reflected irradiance
    shape_temp_offset = -1.0   # moderate cooling
    ...
    out_file = out_dir / "VShape_62cm_TSSC_Winter_15min.csv"

...
print("✅ Inverted-V | 93 cm | TSSC Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_inverted_v_93cm_tssc_winter():
    ...
    spacing_offset = -3.0      # strongest airflow cooling
    ...
    out_file = out_dir / "InvertedV_93cm_TSSC_Winter_15min.csv"
...
if __name__ == "__main__":
    run_inverted_v_93cm_tssc_winter()

...
print("✅ V-Shape | 62 cm | TCT simulation started")
...
def run_vshape_62cm_tct():
    ...
    # ------------------ SHAPE: V-SHAPE
    irr_factor = 1.05          # diffuse + reflection gain
    shape_temp_offset = -1     # moderate cooling
    ...
    out_file = out_dir / "VShape_62cm_TCT_Summer_15min.csv"

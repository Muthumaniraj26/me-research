...
def run_flat_tssc_autumn():
    ...
    # -------- TSSC mismatch gain
    tssc_gain = 1.05   # conservative but realistic
    ...
    for spacing_cm, spacing_offset in spacing_cases.items():
        ...
        out_file = out_dir / f"Flat_{spacing_cm}cm_TSSC_Autumn_15min.csv"

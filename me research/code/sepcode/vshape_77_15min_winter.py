...
print("✅ V-Shape | 77 cm | Se-P | Winter simulation started")
...
def run_vshape_77cm_winter():
    ...
    spacing_offset = 0.0       # neutral airflow condition
    ...
    out_file = out_dir / "VShape_77cm_SeP_Winter_15min.csv"

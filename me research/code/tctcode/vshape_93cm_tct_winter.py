...
print("✅ V-Shape | 93 cm | TCT Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_vshape_93cm_tct_winter():
    ...
    out_file = out_dir / "VShape_93cm_TCT_Winter_15min.csv"

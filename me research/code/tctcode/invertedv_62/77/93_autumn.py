...
print("✅ Inverted-V | TCT | Autumn simulation started")
...
def run_inverted_v_tct_autumn():
    ...
    for spacing_cm, spacing_offset in spacing_cases.items():
        ...
        out_file = out_dir / f"InvertedV_{spacing_cm}cm_TCT_Autumn_15min.csv"
            ...
            for i in range(len(timestamps)-1):
                ...
                for m in [0, 15, 30, 45]:
                    ...
                    w.writerow([
                        ...
                        "Inverted-V", spacing_cm, "TCT", "Autumn",
                        round(G_eff,1),
                        round(T,1),
                        round(T_cell,1),
                        round(Voc_array,2),

...
print("✅ V-Shape | 77 cm | TSSC Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_vshape_77cm_tssc_winter():
    ...
    out_file = out_dir / "VShape_77cm_TSSC_Winter_15min.csv"

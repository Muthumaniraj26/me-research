...
print("✅ Inverted-V | 62 cm | TSSC simulation started")
...
def run_inverted_v_62cm_tssc():
    ...
    shape_temp_offset = -2     # chimney cooling

    # ------------------ SPACING: 62 cm (LOW CLEARANCE)
    spacing_offset = 4         # thermal penalty due to reduced airflow
    ...
    out_file = out_dir / "InvertedV_62cm_TSSC_Summer_15min.csv"

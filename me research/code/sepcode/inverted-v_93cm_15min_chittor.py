...
print("✅ Inverted-V | 93 cm | Se-P Winter simulation started")
...
# MAIN FUNCTION
# ------------------------------------------------------------
def run_inverted_v_93cm_sep_winter():
    ...
    out_file = out_dir / "InvertedV_93cm_SeP_Winter_15min.csv"
...
if __name__ == "__main__":
    run_inverted_v_93cm_sep_winter()
